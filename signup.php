...
<head>
    ...
    if (validateSection('section1') && validateSection('section2') && validateSection('section3')) {
        return true;  
    } else {
        return false; 
    }
        ...
        function validateSection(sectionId) {
            ...
            icon: 'warning'
                ...
                Swal.fire({
                    title: 'Error',
                    text: 'Password should be at least 8 characters long and contain at least one letter and one number and one character.',
                    icon: 'warning'
                });
                return false;
            }
...
<body>
    <div class="registration-container" id="section1">
        <h2>Registration</h2>
        <form id="registrationForm" action="check.php" method="post" autocomplete="off" onsubmit="return validateForm()">
            <label for="user_id">Username:</label>
            <input type="text" id="user_id" name="user_id" maxlength="15" placeholder="Enter your name">
    ...
    <div class="registration-container hidden" id="section2">
        ...
        <input type="password" id="password" name="password" placeholder="Atleast 1 letter, 1 number and 1 character">

        <label for="confirmPassword">Confirm Password:</label>
        <input type="password" id="confirmPassword" name="confirmPassword">

        <button type="button" onclick="showPreviousSection('section2', 'section1')">Back</button>
    ...
    <div class="registration-container hidden" id="section3">
        ...
        <button type="button" onclick="showPreviousSection('section3', 'section2')">Back</button>
